...
/**
 * This is the item provider adapter for a {@link lv.vogella.webpage.model.webpage.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addArticlePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Category_article_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Category_article_feature",
								"_UI_Category_type"),
						WebpagePackage.Literals.CATEGORY__ARTICLE, true, false, true, null, null, null));
	}

...
/**
 * This is the item provider adapter for a {@link lv.vogella.webpage.model.webpage.Web} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WebItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addPagesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Web_pages_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Web_pages_feature", "_UI_Web_type"),
						WebpagePackage.Literals.WEB__PAGES, true, false, true, null, null, null));
	}
